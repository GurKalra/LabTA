...
# HELPER: DOCKER EXECUTION ENGINE
...
def run_investigation(code, language, problem_id, problems_db):
    ...
    logs.append(f"Phase 2: Loading {len(hidden_cases)} isolated test cases...")
